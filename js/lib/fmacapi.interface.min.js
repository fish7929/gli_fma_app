...
function fmacapi_report_exception(a){alert("\u4e00\u4e2a\u9519\u8bef\u53d1\u751f\u5728"+a.fileName+"\u3002\r\n\u9519\u8bef\u4fe1\u606f\uff1a"+a.message)}window.onerror=function(a,b,c){alert("\u4e00\u4e2a\u9519\u8bef\u53d1\u751f\u5728"+b+"\u7b2c"+c+"\u884c\u3002\r\n\u9519\u8bef\u4fe1\u606f\uff1a"+a)};
fmacapi_RegisterNameSpace("fmacloud");AV.initialize("hvyv70z3rdr9y8k95dkcwy4cguj9cxz7xjkysfsx9knolhnw","b74wuaqjvs10m3zmmbyxv4cim74wopzm9a9iojkt5uayfdc1");window.fmacloud=AV;fmacloud.Error.REQUEST_NOT_SUPPORTED="\u60a8\u8c03\u7528\u4e86\u4e0d\u652f\u6301\u7684\u529f\u80fd\u3002";
fmacloud.query_tpl_works=function(f,g,d,h,e,b,i,a){var c=fmacloud.Object.extend("tplobj");c=new fmacloud.Query(c);c.equalTo("tpl_type",f);c.skip(e);c.limit(b);f=false;if(d!=null)h?c.ascending(d):c.descending(d);switch(g){case "all":break;case "onsale":c.greaterThan("approved",0);break;case "not onsale":c.equalTo("approved",0);break;case "editor rec":c.greaterThan("approved",0);c.greaterThan("editor_recno",0);c.ascending("editor_recno");break;case "author rec":c.greaterThan("approved",0);c.greaterThan("author_recno",
0);c.ascending("author_recno");break;default:g=g.split(":");if(g.length>1)switch(g[0]){case "label":g.splice(0,1);c.containsAll("label",g);break;default:f=true;break}}f?a(fmacloud.Error(fmacloud.Error.REQUEST_NOT_SUPPORTED,"")):c.find({success:i,error:a})};
function _fmacloud_execute_queue(){var f=fmacloud.Object.prototype,g=f.task_queue;if(g.length>0){var d=g.shift(),h=d.get("arg1"),e=d.get("arg2");g=d.get("arg3");var b=d.get("arg4"),i=d.get("arg5"),a=d.get("arg6");g(h[e],function(){if(e<h.length-1){d.set("arg2",e+1);f.task_queue.push(d);a==null||a==0?setTimeout("_fmacloud_execute_queue()",0):setTimeout("_fmacloud_execute_queue()",a)}else b(h)},i)}}fmacloud.init_queue_task=function(){var f=fmacloud.Object.prototype;f.task_queue=[]};
fmacloud.execute_array_task=function(f,g,d,h,e,b){fmacloud.init_queue_task();var i=fmacloud.Object.prototype,a=fmaobj.params.create();a.set("arg1",f);a.set("arg2",g);a.set("arg3",d);a.set("arg4",h);a.set("arg5",e);a.set("arg6",b);i.task_queue.push(a);b==null||b==0?_fmacloud_execute_queue():setTimeout("_fmacloud_execute_queue()",b)};fmacloud._fetch_object=function(f,g,d,h){fmacloud.execute_array_task(f,g,function(e,b,i){e.fetch().then(b,i)},function(e){d(e)},h)};
fmacloud.get_tpl_works_data=function(f,g,d){var h=fmacloud.Object.extend("pages_data");h=new fmacloud.Query(h);h.equalTo("key_id",f);h.find().then(function(e){if(e.length>0){var b=e[0];e=b.get("pages");fmacloud._fetch_object(e,0,function(i){fmacloud.execute_array_task(i,0,function(a,c,j){a=a.get("item_object");fmacloud._fetch_object(a,0,c,j)},function(){g(b)},d)},d)}else d(fmacloud.Promise.error("\u6307\u5b9aID\u7684\u6570\u636e\u4e0d\u5b58\u5728\u3002"))},function(e){d(e)})};
fmacloud.erase_tpl_works=function(f,g,d,h){try{var e=fmacloud.Object.extend("pages_data"),b=new fmacloud.Query(e);g.destroy({success:function(a){d(a)},error:function(a,c){alert("\u5220\u9664\u5bf9\u8c61\u5931\u8d25\uff1a"+a.get("objectid")+"\u539f\u56e0\u662f\uff1a"+c);h(a,c)}});b.equalTo("key_id",f);b.find({success:function(a){for(var c=0;c<a.length;c++){for(var j=a[0],k=j.get("pages"),l=0;l<k.length;l++){var u=k[l];u.fetch({success:function(p){for(var q=p.get("item_object"),s=0;s<q.length;s++){var v=
q[s];v.fetch({success:function(n){var m=null;if(n.get("item_cntype")==2)m=fmacapi_filename_fromurl(n.get("item_val"));else if(n.get("item_cntype")==3)m=n.get("item_val");if(m!=null){m=j.get("key_id")+"."+m;var r=fmacloud.Object.extend("_File");r=new fmacloud.Query(r);r.equalTo("name",m);r.find({success:function(o){if(o.length>0){var t=new fmacloud.File;t.id=o[0].id;t.destroy().then(function(){},function(w){alert("\u6587\u4ef6\u5220\u9664\u5931\u8d25\uff1a"+w.message)})}},error:function(o){alert("\u67e5\u627e\u6587\u4ef6\u5bf9\u8c61\u5931\u8d25: "+
o.code+" "+o.message)}})}n.destroy()},error:function(){alert("elem\u5b50\u5bf9\u8c61fetch\u5931\u8d25\uff0c\u539f\u56e0\uff1a"+error.code+" "+error.message)}})}p.destroy()},error:function(){alert("page\u5b50\u5bf9\u8c61fetch\u5931\u8d25\uff0c\u539f\u56e0\uff1a"+error.code+" "+error.message)}})}j.destroy({success:function(){},error:function(p,q){alert("\u5220\u9664\u6570\u636e\u5931\u8d25\uff1a"+p.get("objectid")+"\u539f\u56e0\u662f\uff1a"+q)}})}},error:function(a){alert("\u67e5\u627e\u6570\u636e\u5931\u8d25\uff1a"+
a.message)}})}catch(i){fmacapi_report_exception(i)}};function fma_getMSec(){var f=new Date;return f.getMilliseconds()}
fmacloud.tpl_save_all=function(f,g,d,h,e){var b=f.get("effect_img");if(b.substr(0,3)=="AV:")b=b.slice(3);console.log("effect:"+fma_getMSec());var i=new AV.File(b+".png",{base64:d.effect_img});i.save().then(function(){f.set("effect_img","AV:"+i.url());fmacloud.execute_array_task(d.elem_imgs,0,function(a,c){console.log(a[1]+":"+fma_getMSec());var j=g.get("pages")[a[0]];j=j.get("item_object");var k=j[a[1]];if(k.get("item_cntype")==2){j=k.get("item_val");var l=j.lastIndexOf("/");b=j.substr(l+1,j.length-
l-1)}else if(k.get("item_cntype")==3){b=k.get("item_val");if(b.substr(0,3)=="AV:")b=b.slice(3)}else b=fmacapi_create_uid();i=new fmacloud.File(b+".png",{base64:a[2]});i.save().then(function(){k.set("item_cntype",2);k.set("item_val",i.url());c(a)},e)},function(){console.log("tpldata:"+fma_getMSec());g.save().then(function(){console.log("tplobj:"+fma_getMSec());f.save().then(function(){h(f)},e)},e)},e,1200)},function(a){e(a)})};
...
a.set("render_version",2);a.set("editor_recno",0);a.set("author_recno",0);a.set("sale_pos",0);a.set("label",[]);a.set("inherit_from","");return a},test:function(){alert("test!")}};fmaobj.tpl_data={create:function(a){var i=new (fmacloud.Object.extend("pages_data"));i.set("key_id",a==null?"none":a);i.set("pages",[]);return i}};
...
(function(){function a(b){return new a.fn.init(b)}var i=1;offline=false;a.fn=a.prototype={constructor:a,init:function(){return this},env:function(){return i},tpl_query:function(b,c,d,e,f,h,g,j){fmacloud.query_tpl_works(b,c,d,e,f,h,g,j)},tpl_get_data:function(b,c,d){fmacloud.get_tpl_works_data(b,c,d)},tpl_effect_img_url:function(b){var c=b.get("effect_img");return c.substr(0,3)=="AV:"?c.slice(3):fms_res_path+fms_res_store+b.get("tpl_id")+"/"+b.get("effect_img")},tpl_res_img_url:function(b,c,d){var e=
null;if(c==2)e=d;else if(c==3)e=fms_res_path+fms_res_store+b+"/"+d;return e},tpl_save_all:function(b,c,d,e,f){return fmacloud.tpl_save_all(b,c,d,e,f)},tpl_save_obj:function(b,c,d){b.save(null,{success:c,error:d})},works_save_data:function(b,c,d){b.save(null,{success:c,error:d})},get_upsale_pos:function(b){return b<l.length?l[b]:null},copy_remote_resource:function(b,c,d){var e=b.get("arg1"),f=b.get("arg2");b=b.get("arg3");var h="";if(e.get("item_cntype")==2){var g=e.get("item_val"),j=g.lastIndexOf("/");
h=g.substr(j+1,g.length-j-1)}else if(e.get("item_cntype")==3)h=e.get("item_val");else return false;g=f.lastIndexOf("/");var k=f.substr(g+1,f.length-g-1);k=b+"."+k;var m=fmacloud.File.withURL(k,f);m.save().then(function(){k=m.name();if(h!=""){var n=new fmacloud.File(h);n.destroy().then(function(){},function(){})}c(e)},d);return true},exit_app:function(){fmantv.exit_app()}};window.fmacapi=a.fn;var l=[["",""],["A-1","\u5927\u56fe\u5c55\u793a\u533a"],["A-2","\u7126\u70b9\u56fe"],["A-3","\u70ed\u95e8\u7011\u5e03\u6d41"],
["A-4","\u4e3b\u9898\u7011\u5e03\u6d41"]]})();
